...
const Login = ({ setToken }) => {
  ...
  const signIn = async (e) => {
    ...
    try {
      const endpoint = "https://login-backend-auth.onrender.com/login";
      ...
      // Store token in cookie and localStorage for persistence
        ...
        <div className="p-6 border-b border-gray-700 flex justify-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-400 mt-1">
              Entre com suas credenciais para acessar a API
            </p>
          </div>
        </div>
